    ...
    <section>
        <div
            ...
            <div
                class="jarallax-img"
                style="
              background-image: url(assets/img/landing/shop/hero/bg.jpg);
            "></div>
            <div
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="position-relative">
                        <img
                            class="rounded-1"
                            src="assets/img/landing/shop/blog/01.jpg"
                            alt="Post image" />
                        <div class="pt-3 mt-3">
                            <h3 class="h4 mb-3">
                ...
                <div class="swiper-slide">
                    <div class="position-relative">
                        <img
                            class="rounded-1"
                            src="assets/img/landing/shop/blog/02.jpg"
                            alt="Post image" />
                        <div class="pt-3 mt-3">
                            <h3 class="h4 mb-3">
                                <a class="stretched-link" href="landing-shop.html#"
                ...
                <div class="swiper-slide">
                    <div class="position-relative">
                        <img
                            class="rounded-1"
                            src="assets/img/landing/shop/blog/03.jpg"
                            alt="Post image" />
                        <div class="pt-3 mt-3">
                            <h3 class="h4 mb-3">
                                <a class="stretched-link" href="landing-shop.html#"
