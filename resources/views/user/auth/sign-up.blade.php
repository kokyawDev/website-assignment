    ...
    <div class="d-lg-flex position-relative h-100">
        ...
        <div class="d-flex flex-column align-items-center w-lg-50 h-100 px-3 px-lg-5 pt-5">
            <div class="w-100 mt-auto" style="max-width: 526px;">
                ...
                <p class="pb-3 mb-3 mb-lg-4">Have an account already?&nbsp;&nbsp;<a href='{{ route('sign-in') }}'>Sign in here!</a></p>
                <form class="needs-validation" novalidate>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 gy-3">
                        <div class="col"><a class="btn btn-icon btn-outline-secondary btn-google btn-lg w-100" href="account-signup.html#"><i class="ai-google fs-xl me-2"></i>Google</a></div>
                        <div class="col"><a class="btn btn-icon btn-outline-secondary btn-facebook btn-lg w-100" href="account-signup.html#"><i class="ai-facebook fs-xl me-2"></i>Facebook</a></div>
                    </div>
                </form>
            </div>
            <!-- Copyright-->
