                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                    <div>
                        ...
                        <textarea rows="5" name="short_description" id="short_description"
                                  ...
                                  placeholder="Type Short Description">{{ old('short_description') ?? $post->short_description }}</textarea>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                    <div>
                        ...
                        <textarea rows="5" name="description" id="description"
                                  ...
                                  placeholder="Type Description">{{ old('description') ?? $post->description }}</textarea>
