...
<!-- Update modal -->
<div id="updateProductModal-{{ $post->id }}" tabindex="-1" aria-hidden="true"
     class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
...
<!-- Read modal -->
<div id="readProductModal-{{ $post->id }}" tabindex="-1" aria-hidden="true"
     class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
...
{{--                    <p class="font-bold">$2999</p>--}}
            ...
            <dl>
                ...
                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $post->name }}</dd>
                <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Is Published</dt>
                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $post->is_published ? 'true' : 'false' }}</dd>
            </dl>
